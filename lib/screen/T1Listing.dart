              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                              ...
                              children: <Widget>[
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    text(model.duration, fontSize: textSizeMedium),
                                  ],
                                ),
                                text(model.designation, fontSize: textSizeLargeMedium, textColor: t1TextColorPrimary, fontFamily: fontMedium),
                              ],
                            ),
                          ),
                        )
                    ...
                    text(t1_samplelong_text, fontSize: textSizeMedium, maxLine: 2, textColor: t1TextColorPrimary),
                  ],
                ),
              ),
              Container(
